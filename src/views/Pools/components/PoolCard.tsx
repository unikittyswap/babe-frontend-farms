...
import { Button, IconButton, useModal, AddIcon, Image } from '@babefinance/uikit'
...
const PoolCard: React.FC<HarvestProps> = ({ pool }) => {
  ...
  // APY
  const rewardTokenPrice = 0.01
  const stakingTokenPrice = 0.01
    ...
    <Card isActive={isCardActive} isFinished={isFinished && sousId !== 0}>
      ...
      <div style={{ padding: '24px' }}>
        <CardTitle isFinished={isFinished && sousId !== 0}>
          {isOldSyrup && '[OLD]'} {stakingTokenName} {TranslateString(348, 'Pool')}
        </CardTitle>
