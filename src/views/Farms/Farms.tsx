...
import { Image, Heading, RowType, Toggle, Text } from '@babefinance/uikit'
    ...
    (farmsToDisplay): FarmWithStakedValue[] => {
      ...
      let farmsToDisplayWithAPY: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        if (farm.quoteTokenSymbol === QuoteToken.BUSD || farm.quoteTokenSymbol === QuoteToken.UST) {
          const divder = farm.lpTotalInQuoteToken > 0 ? farm.lpTotalInQuoteToken : 1;

          apy = cakePriceVsBNB.times(cakeRewardPerYear).div(divder).times(bnbPrice);
        } else if (farm.quoteTokenSymbol === QuoteToken.ETH) {
          apy = cakePrice.div(ethPriceUsd).times(cakeRewardPerYear).div(farm.lpTotalInQuoteToken ? farm.lpTotalInQuoteToken : 1)
